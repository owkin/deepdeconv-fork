...
DECONV_METHODS = {
    ...
    "MixUpVI_v2": {
        ...
        "adata_train": None,
        "model_path": "project/mixupvi_v2_FACS_kl_bulk_centroid_to_pseudo_centroid_scheduled",
...
GRANULARITY_TO_EVALUATION_DATASET = {
    ...
    "3rd_level_granularity": "CTI",
    "4th_level_granularity": "CTI",
    "FACS_1st_level_granularity": "BULK_FACS", # This change was made to evaluate the model on the pseudobulks instead of the bulks, change back to BULK_FACS!!!!
